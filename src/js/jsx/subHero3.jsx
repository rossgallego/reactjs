	...
	render: function(){
		return(
			        ...
			        <div>
				          ...
				          <img className='cube-thumb' src= {this.state.arraye[9].images.normal}/>
				          <h3>{this.state.arraye[9].title}</h3>
				          
				          <p><a className="btn btn-primary" href={this.state.arraye[9].html_url}>more Info</a></p>
